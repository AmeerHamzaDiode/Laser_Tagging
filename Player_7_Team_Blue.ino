...
const uint32_t sendHex = 0x4000F00F; // Replace with this player's unique hex code

const uint32_t receiveHex[] = {0xF00F0001, 0xF00F8001, 0xF00F4001, 0xF00FC001, 0xF00F2001, 0xF00FA001};
const uint8_t opponentIDs[] = {1, 2, 3, 4, 5, 6};
